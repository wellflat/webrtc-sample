...
async def run(player, room, session):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--url", default='http://localhost:8088/janus', help="Janus root URL, e.g. http://localhost:8088/janus")
    parser.add_argument(
        "--room",
        type=int,
        default=1234,
    ...
    try:
        loop.run_until_complete(run(player=player, room=args.room, session=session))
